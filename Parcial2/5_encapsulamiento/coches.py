...
#El encapsulamiento en python tambien es llamado visibilidad, y practicamente se puede hacer que un atributo y/o metodo sea publico o privado 
...
#Nota 1, para utilizar un atributo privado es necesario hacerlo a traves de un metodo publico
...
#Nota2 para utilizar un metodo privado es necesario hacer dentro de un publico
